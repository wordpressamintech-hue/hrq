...
export function ContactPage() {
  ...
  const handleSubmit = async (e: any) => {
    ...
    const { name, email, company, phone, industry, service, message } =
      formData;
    ...
    try {
      ...
      setError(
        "Unable to submit form at this time. Please try again later or contact us directly."
      );
    } finally {
      setLoading(false);
    }
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Ready to transform your HR operations? Get in touch with our experts
                    ...
                    <div>
                      ...
                      >
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="hr-audit">
                            HR Audit & Assessment
                          </SelectItem>
                          <SelectItem value="policy">
                            HR Policy Development
                          </SelectItem>
                          <SelectItem value="employee-relations">
                            Employee Relations
                          </SelectItem>
                          <SelectItem value="compensation">
                            Compensation & Rewards
                          </SelectItem>
                          <SelectItem value="hr-analytics">
                            HR Analytics & Reporting
                          </SelectItem>
                          <SelectItem value="full-outsourcing">
          ...
          >
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Our team of HR experts is ready to help you streamline your
                human resources operations and drive business growth.
              </p>
            </div>
